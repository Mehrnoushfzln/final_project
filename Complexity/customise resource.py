...
data = ["AWS", "AWS", "Azure", "AWS", "Azure", "AWS", "GCP", "AWS", "AWS", "AWS", "AWS", "AWS"]
...
plt.axis('equal')
plt.title('Cloud Platform Preference for Customising Resources')
plt.show()

# Determine the platform with the highest count
max_platform = max(platform_counts, key=platform_counts.get)
print(f"Based on the responses, {max_platform} is considered more capable of customising resources.")
